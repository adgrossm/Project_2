...
A well-known Australian Jedi, I have a degree in sport.", now(), now());
...
travelling and cycling. I am inspiring and giving, but can also be very sadistic and a bit cowardly. Physically, Elizabeth is in pretty good shape.", now(), now());
...
but otherwise in good shape.", now(), now());
...
chess and jigsaw puzzles. I am energetic and bright, but can also be very greedy and a bit unkind.", now(), now());
